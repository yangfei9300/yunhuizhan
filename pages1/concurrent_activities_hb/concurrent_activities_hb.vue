	...
	<view>
		...
		<view class="colonn center_center" v-if="current==2">
			...
			<view class="colonn">
				...
				>
					<image class="imagesactivew" 
					mode="aspectFill" style="border-radius: 10rpx;" :src="item.image+'?x-oss-process=style/luntan1'"></image>
					<view class="colonn rowsbl">
						...
						<view  class="fs-30 w-400 txtShowLength" style="color: #999999;">活动时间：{{item.startTime}}</view>
					</view>   
				</view>
...
<style>
@import url("concurrent_activities_hb.css");
</style>
