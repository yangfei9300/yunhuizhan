<template>
	<view class="like-button" style="z-index: 50000;">
		<!-- #ifdef APP-NVUE -->
		...
		<!-- #endif -->
		<view class="on-button roww center_center" @click.stop="handleClick">
			<image
				:src="src"
				mode="widthFix"
				:style="{
				...
				v-if="!$slots.default"
			></image>
			<view class="el_like_btn" @click.stop="handleClick"><slot></slot></view>
		</view>
	</view>
</template>  
